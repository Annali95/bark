...
class PlotCanvas(FigureCanvas):
    ...
    def __init__(self, origin_data, trace_num, gap, sampled, opstack, keymap, outfile, out_attrs, opsfile=None, parent=None, width=5, height=10, dpi=100):
        ...
        self.N_points = int(round(self.sr*self.gap*6)) 
    ...
    def update_plot_data(self):
        ...
        if self.N_points > int(round(self.sr*self.gap*10)):
            if not self.origin_data.empty:           
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.reviewer = PlotCanvas(origin_labels,trace_num, gap, sampled, opstack, shortcuts, outfile, attrs, opsfile, parent = self, width=5, height=height)
